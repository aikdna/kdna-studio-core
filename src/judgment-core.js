...
function validateJudgmentCore(value) {
  ...
  if (Object.hasOwn(value, "highest_question")) {
    validateString(
      value.highest_question,
      "judgment_core.highest_question",
      issues,
    );
  }
  ...
  if (Object.hasOwn(value, "judgment_role")) {
    ...
    if (!isObject(role)) {
      ...
      if (Object.hasOwn(role, "acts_as")) {
        validateString(
          role.acts_as,
          "judgment_core.judgment_role.acts_as",
          issues,
        );
      }
      ...
      if (Object.keys(role).length === 0) {
        issues.push(
          "judgment_core.judgment_role: expected at least one declared role field",
        );
      }
    }
  }
